...
###Cabe precisar que, según este método, no hay mal clusterizados (Ver Anexo 2: Análisis de Clusters)
...
library(readxl)
TRABAJO_1 <- read_excel("BASE DE DATOS EDUCACIÓN/TRABAJO 1.xlsx")
View(TRABAJO_1)
...
library(readxl)
TRABAJO_2 <- read_excel("D:/Estadística 2/TRABAJO GRUPO 5/BASE DE DATOS EDUCACIÓN/TRABAJO 2.xlsx")
View(TRABAJO_2)
